...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dataclasses-json-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12608&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dataclasses-json-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dataclasses-json` can be installed with:

```
conda install dataclasses-json
```

It is possible to list all of the versions of `dataclasses-json` available on your platform with:
